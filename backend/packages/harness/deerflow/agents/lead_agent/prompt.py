...
def _build_subagent_section(
    ...
    *,
    ...
    if allowed_subagents is not None:
        available_names = get_available_subagent_names(app_config=app_config, allowed_subagents=allowed_subagents)
    else:
        available_names = get_available_subagent_names(app_config=app_config, allowable_subagents=allowable_subagents)

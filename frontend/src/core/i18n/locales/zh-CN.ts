...
export const zhCN: Translations = {
  ...
  inputBox: {
    ...
    mode: "模式",
    approvalMode: "审批模式",
    approvalModeAlways: "总是审批",
    approvalModeAlwaysDescription: "每次操作前都请求人工审批",
    approvalModeOnAmbiguity: "模糊时审批",
    approvalModeOnAmbiguityDescription: "在查询意图存在歧义时请求审批",
    approvalModeAuto: "系统自动审批",
    approvalModeAutoDescription: "由系统自动判断并继续执行",
    flashMode: "闪速",
  ...
  tokenUsage: {
    ...
    collecting: "统计中",
    note: "顶部总量优先使用后端持久化的线程用量；当当前回复仍在流式返回时，还会叠加可见的进行中用量。缓存明细仅在供应商返回缓存命中 Token 后显示。每轮和调试用量只来自当前可见消息，可能与平台账单页不完全一致。",
    presets: {
      off: "关闭",
      summary: "总览",
      perTurn: "每轮",
